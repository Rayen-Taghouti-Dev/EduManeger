    ...
    <>
      {compact ? (
        ...
        >
          ...
          <span className="min-w-0 flex-1 truncate text-left text-sm leading-none">Rechercher...</span>
      ...
      {open && (
        <>
          ...
          <div
            role="dialog"
            aria-label="Menu de commandes"
            className="bg-surface fixed top-[15%] left-1/2 z-50 w-[calc(100%-2rem)] max-w-lg -translate-x-1/2 overflow-hidden rounded-lg border shadow-lg sm:top-[20%]"
          >
              ...
              {commands.map((cmd) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="truncate text-left leading-none">{cmd.title}</span>
                  </button>
                );
              })}
            </div>
